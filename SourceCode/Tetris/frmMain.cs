...
namespace Game
{
    public partial class frmMain : Form
    {
        ...
        public int  Speed  = 1;     // Speed of the game.
        public int  Level  = 1;     // Level of the game.
        public int  Score  = 0;     // Total score.
        public int  Lines  = 0;     // Total lines completed.

        public Boolean isProcessRow  = false;
        public Boolean isGameStart   = false;
        public Boolean isGameOver    = false;
        public Boolean isGameSuccess = false;
        public Boolean isCanRotate   = false;  
