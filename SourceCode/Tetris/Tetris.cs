...
namespace Game
{
    ...
    public struct StructBlockStyle
    {
    ...
    {
        public static int BLOCK_SIZE = 4; // size of the block(4v4)

        public static bool[] arrBlock = new bool[BLOCK_SIZE << 2];
        public static WindowRect TetrisField = new WindowRect();
        public static Point m_blockpos = new Point();
        public static StructBlock m_block = new StructBlock();
        public static int m_Width;
        public static int m_Height;
        public static StructBlockStyle[] arrField;
    }

    public class BlockClass : BaseClass
    {
